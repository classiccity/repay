...
// THE BLOCKS
add_action('acf/init', 'blog_posts_custom_acf_blocks');
function blog_posts_custom_acf_blocks() {
    if( function_exists('acf_register_block') ) {
        ...
        acf_register_block_type(array(
            'name'              => 'blog-posts',
            'title'             => 'Blog Posts',
            'description'       => 'Shows a list of Blog Posts in a lot of different ways',
            'render_template'   => 'inc/blog-posts/blocks/templates/blog-posts.php',
            ...
            'keywords'          => array( 'blog', 'posts', 'article','grid','carousel' ),
        ));
